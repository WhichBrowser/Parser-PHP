...
The `WhichBrowser` object contains the following properties:
...
The `WhichBrowser` object contains the following functions:
...
The `browser` object contains the following properties:
...
* `channel`  
  a string containing the distribution channel, ie. 'Beta' or 'Nightly' or 'Next'.
* `mode`  
...
The `engine` object contains the following properties:
...
The `os` object contains the following properties:
...
A version object contains the following properties:
...
A version object can also contain the following functions:
