...
Applications::$BROWSERS = [
    ...
    Constants\BrowserType::BROWSER => [
        ...
        [ 'name' => 'ICE Browser',          'id'    => 'icebrow',     'regexp' => '/ICE browser\/v?([0-9.]*)/i', 'type' => Constants\DeviceType::DESKTOP ],                  // see: http://www.icesoft.org/java/home.jsf
        [ 'name' => 'ICE Browser',          'id'    => 'icebrow',     'regexp' => '/ICEbrowser\/v?([0-9.]*)/i', 'type' => Constants\DeviceType::DESKTOP ],
