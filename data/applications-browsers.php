...
Applications::$BROWSERS = [
    ...
    Constants\BrowserType::BROWSER => [
        ...
        [ 'name' => 'Seznam Browser',       'id'    => 'seznamapp',      'regexp' => '/SznProhlizec\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],            // see: https://play.google.com/store/apps/details?id=cz.seznam.sbrowser&hl=en
        ...
        [ 'name' => 'Seznam Browser',       'id'    => 'seznamapp',      'regexp' => '/SznProhlizec\/([0-9.]*)/u', 'type' => Constants\DeviceType::MOBILE ],            // see: https://play.google.com/store/apps/details?id=cz.seznam.sbrowser&hl=en
