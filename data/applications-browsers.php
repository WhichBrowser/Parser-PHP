...
Applications::$BROWSERS = [
    ...
    Constants\BrowserType::BROWSER => [
        ...
        [ 'name' => 'Adventurer',           'id'    => 'adventurer',  'regexp' => '/[Aa]dventurer\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'Avast Secure Browser', 'id'    => 'aventsec',    'regexp' => '/ Secure\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],                      // see: https://www.avast.com/secure-browser#pc
        ...
        [ 'name' => 'Baidu Spark',          'id'    => 'bdspark',     'regexp' => '/ Spark\/([0-9]*)/u', 'details' => 2 ],
        ...
        [ 'name' => 'Coc Coc',              'id'    => 'coocoo',      'regexp' => '/coc_coc_browser\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],              // see: https://coccoc.com/en/
        ...
        [ 'name' => 'Deepnet Explorer',     'id'    => 'deepexpl',    'regexp' => '/Deepnet Explorer ([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        [ 'name' => 'Dillo',                'id'    => 'dillo',       'regexp' => '/Dillo\/([0-9.]*)/u' ],                                                                 // see: http://www.dillo.org
        [ 'name' => 'Doga Rhodonit',        'id'    => 'rhodonit',    'regexp' => '/DogaRhodonit/u' ],
        [ 'name' => 'Element Browser',      'id'    => 'element',     'regexp' => '/Element Browser ([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'Hv3 Browser',          'id'    => 'hv3',         'regexp' => '/ Hv3\/([0-9.a-z]*)/u', 'type' => Constants\DeviceType::DESKTOP ],                      // see: http://tkhtml.tcl.tk/hv3.html
        ...
        [ 'name' => 'Juzi Browser',         'id'    => 'juzi',        'regexp' => '/JuziBrowser/iu', 'type' => Constants\DeviceType::DESKTOP ],                            // see: http://www.123juzi.com/
        ...
        [ 'name' => 'Kirix Strata',         'id'    => 'kirix',       'regexp' => '/ Strata\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],                      // see: https://www.kirix.com/
        [ 'name' => 'K-Meleon',             'id'    => 'meleon',      'regexp' => '/K-Meleon\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],                     // see: http://kmeleonbrowser.org
        [ 'name' => 'K-Ninja',              'id'    => 'kninja',      'regexp' => '/K-Ninja\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        [ 'name' => 'KKMAN Browser',        'id'    => 'kkman',       'regexp' => '/ KKman([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],                         // see: https://www.kkbox.com/kkman/
        ...
        [ 'name' => 'Light Browser',        'id'    => 'light',       'regexp' => '/ Light\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],                       // see: https://en.wikipedia.org/wiki/Light_(web_browser)
        ...
        [ 'name' => 'QtWeb',                'id'    => 'qtweb',       'regexp' => '/ Qt\/([0-9.]*)/u' ],                                                                   // see: http://www.qtweb.net/
        [ 'name' => 'QtWeb',                'id'    => 'qtweb',       'regexp' => '/QtWebEngine\/([0-9.]*)/u' ],                                                           // see: https://en.wikipedia.org/wiki/QtWeb
        ...
        [ 'name' => 'Seznam Browser',       'id'    => 'seznam',      'regexp' => '/SznProhlizec\/([0-9.]*)/u' ],                                                          // see: https://play.google.com/store/apps/details?id=cz.seznam.sbrowser&hl=en
        ...
        [ 'name' => 'SlimerJS',             'id'    => 'slimerjs',    'regexp' => '/ SlimerJS\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],                    // see: https://slimerjs.org/
        [ 'name' => 'SlimJet Browser',      'id'    => 'slimjet',     'regexp' => '/ Slimjet\/([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],                     // see: https://www.slimjet.com/
        ...
        [ 'name' => 'VMware Browser',       'id'    => 'vmware',      'regexp' => '/Air[Ww]atch Browser v([0-9.]*)/u', 'type' => Constants\DeviceType::DESKTOP ],
        ...
        [ 'name' => 'Mobicip',                   'id'    => 'mobicip',       'regexp' => '/ Mobicip\/([0-9.]*)/u', 'type' => Constants\DeviceType::MOBILE ],                     // see: https://www.mobicip.com/
        ...
        [ 'name' => 'START Internet Browser',    'id'    => 'startbrowser',  'regexp' => '/ Start\/([0-9.]*)/u', 'type' => Constants\DeviceType::MOBILE ],                       // see: https://play.google.com/store/apps/details?id=fyi.start.web.browser    
        ...
        [ 'name' => 'Surf Browser',              'id'    => 'surfbrowser',   'regexp' => '/SurfBrowser\/([0-9.]*)/u', 'type' => Constants\DeviceType::MOBILE ],                  // see: https://en.wikipedia.org/wiki/Surf_(web_browser)
